...
($jscomp.polyfill = function (t, e, n, a) {
    ...
    (function (n) {
        ...
        function c(t, e) {
            return (
                (t = X(t, "bVisible")), -1 !== (e = P.inArray(e, t)) ? e : null
            );
        }
        function m(t) {
            var n = 0;
        ...
        function at(t, e, n) {
            ...
            if (e) {
                ...
                for (var s = 0, l = e.length; s < l; s++) {
                    for (
                        r[s] = e[s].slice(), r[s].nTr = e[s].nTr, a = i - 1;
                        0 <= a;
                        a--
                    )
                ...
                var e = [],
                    ...
                    c =
                        ...
                        i !== R &&
                            -1 !== i &&
                            ((t._iDisplayStart =
                                !s && i >= t.fnRecordsDisplay() ? 0 : i),
                            (t.iInitDisplayStart = -1)),
                        (i = t._iDisplayStart),
                        t.fnDisplayEnd());
                if (t.bDeferLoading)
                    (t.bDeferLoading = !1), t.iDraw++, g(t, !1);
                else if (s) {
                    if (!t.bDestroying && !lt(t)) return;
                } else t.iDraw++;
                if (0 !== l.length)
                    for (
                        o = s ? t.aoData.length : c, s = s ? 0 : i;
                        s < o;
                        s++
                    ) {
                        var u,
        ...
        function st(a, t, e) {
            ...
            P.isPlainObject(l) &&
                ...
                a.fnServerData
                    ...
                    ? (a.jqXHR = P.ajax(
                          P.extend(s, { url: l || a.sAjaxSource })
                      ))
                    : "function" == typeof l
        ...
        function ct(t) {
            for (
                var e = t.aoColumns,
                    ...
                    s = w(t),
                    l = t._iDisplayStart,
                    c = !1 !== a.bPaginate ? t._iDisplayLength : -1,
                    u = function (t, e) {
        ...
        function ht(t, e, n) {
            ...
            if ((b(t), "ssp" != I(t))) {
                for (
                    bt(t, e.sSearch, n, r(e), e.bSmart, e.bCaseInsensitive),
                        a(e),
                        e = 0;
                    e < i.length;
                    e++
                    ...
                    for (var s, l = [], c = 0, u = e.length; c < u; c++)
                        (a = e[c]).bSearchable
                            ...
                            s.indexOf &&
                                -1 !== s.indexOf("&") &&
                                ((xe.innerHTML = s),
                                (s = Ce ? xe.textContent : xe.innerText)),
                            s.replace && (s = s.replace(/[\r\n\u2028]/g, "")),
                            l.push(s);
                    (i._aFilterData = l),
                        (i._sFilterRow = l.join("  ")),
                        (a = !0);
                }
            }
            return a;
        ...
        function Pt(n) {
            ...
            n.scrollBarVis !== F && n.scrollBarVis !== R
                ...
                : ((n.scrollBarVis = F),
                  ...
                  (f.width = k(i)),
                  (s =
                      S.height() > p.clientHeight ||
                      "scroll" == g.css("overflow-y")),
                  (f[(l = "padding" + (T.bScrollbarLeft ? "Left" : "Right"))] =
                      s ? c + "px" : "0px"),
                  w &&
                      ((y[0].style.width = k(i)),
                      (m[0].style.width = k(i)),
        ...
        function Rt(t) {
            ...
            for (
                ...
                var g = a[l[e]];
                null !== g.sWidth &&
                    ((g.sWidth = Ot(g.sWidthOrig, d)), (f = !0));
            }
            if (p || (!f && !o && !r && s == m(t) && s == c.length))
                for (e = 0; e < s; e++)
                    null !== (l = N(t, e)) &&
                        (a[l].sWidth = k(c.eq(e).width()));
            else {
                ...
                for (
                    s.find("thead, tfoot").remove(),
                        s
                            .append(P(t.nTHead).clone())
                            .append(P(t.nTFoot).clone()),
            ...
            for (
                ...
                for (
                    ...
                    var l = i[a],
                        c = n[l].sType || "string";
                    o[t]._idx === R &&
                        (o[t]._idx = P.inArray(o[t][1], n[l].asSorting)),
                        e.push({
                            src: s,
                            col: l,
                            dir: o[t][1],
        ...
        function Wt(t) {
            ...
            if (o.bSort && o.bSortClasses) {
                for (o = 0, e = n.length; o < e; o++) {
                    var i = n[o].src;
                    P(H(t.aoData, "anCells", i)).removeClass(
                        a + (o < 2 ? o + 1 : 3)
                    );
                }
                for (o = 0, e = r.length; o < e; o++)
                    (i = r[o].src),
                        P(H(t.aoData, "anCells", i)).addClass(
                            a + (o < 2 ? o + 1 : 3)
                        );
            }
            t.aLastSort = r;
        ...
        function Vt(n, t, a) {
            ...
            (t = function (t) {
                if (t && t.time) {
                    var e = C(n, "aoStateLoadParams", "stateLoadParams", [
                        n,
                        t,
                    ]);
                    if (
                        ...
                        if (
                            ...
                            t.search !== R &&
                                P.extend(n.oPreviousSearch, St(t.search)),
                            t.columns)
                        )
                            for (r = 0, o = t.columns.length; r < o; r++)
                                (e = t.columns[r]).visible !== R &&
                ...
                n.oFeatures.bStateSave
                    ? (e = n.fnStateLoadCallback.call(n.oInstance, n, t)) !==
                          R && t(e)
                    : a();
        }
        function Xt(t) {
            ...
            P.each(
                ...
                function (t, e) {
                    (f.type.order[t + n + "-pre"] = e),
                        t.match(/^html\-/) &&
                            (f.type.search[t + n] = f.type.search.html);
                }
            );
        }
        function Qt(e) {
                ...
                return (
                    this.each(function () {
                        ...
                        if ("table" != this.nodeName.toLowerCase())
                            ...
                            for (
                                var i = A.settings, a = 0, s = i.length;
                                a < s;
                                a++
                            ) {
                                var l = i[a];
                            ...
                            (null !== t && "" !== t) ||
                                (this.id = t =
                                    "DataTables_Table_" + A.ext._unique++);
                            var u,
                        ...
                        this.iterator("row", function (t, e, n) {
                            for (
                                ...
                                var l = r[i],
                                    c = l.anCells;
                                if (
                                    (null !== l.nTr && (l.nTr._DT_RowIndex = i),
                                    null !== c)
                                )
            ...
            Re =
                ...
                (A.defaults = {
                    ...
                    oLanguage: {
                        ...
                        sSearchPlaceholder: "",
                        sUrl: "",
                        sZeroRecords: "Hasil tidak di temukan",
                    },
        ...
        P.extend(Re, {
            ...
            P.extend(A.ext.type.detect, [
                function (t, e) {
                    return (
                        (e = e.oLanguage.sDecimal), te(t, e) ? "num" + e : null
                    );
                },
                function (t, e) {
                ...
                function (t, e) {
                    return (
                        ...
                        te(t, e, !0) ? "num-fmt" + e : null
                    );
                },
                function (t, e) {
                    return (
                        (e = e.oLanguage.sDecimal),
                        ee(t, e) ? "html-num" + e : null
                    );
                },
                function (t, e) {
                    return (
                        (e = e.oLanguage.sDecimal),
                        ee(t, e, !0) ? "html-num-fmt" + e : null
                    );
                },
                function (t, e) {
                    return o(t) ||
                ...
                header: {
                    ...
                    jqueryui: function (r, o, i, s) {
                        P("<div/>")
                            ...
                            .append(
                                P("<span/>").addClass(
                                    s.sSortIcon + " " + i.sSortingClassJUI
                                )
                            )
                            .appendTo(o),
                            P(r.nTable).on(
    ...
    (function (n) {
            ...
            l =
                (d.extend(n.prototype, {
                    ...
                    _columnsVisiblity: function (e) {
                        ...
                        for (
                            i =
                                (i = t.settings()[0].oScroll).sY || i.sX
                                    ? i.iBarWidth
                                    : 0,
                            ...
                            function (t) {
                                if (
                                    ...
                                    if ("number" == typeof r) {
                                        var e =
                                            r < 0
                                                ? a.columns().eq(0).length + r
                                                : r;
                                        if (a.cell(this).index().column !== e)
                                            return;
                                    }
                    ...
                    _find: function (t) {
                        for (
                            var e = this.c.breakpoints, n = 0, a = e.length;
                            n < a;
                            n++
                        )
                    ...
                    _resize: function () {
                        ...
                        for (
                            this.s.current = l, a = !1, s = 0, e = o.length;
                            s < e;
                            s++
                        )
                        ...
                        t
                            ...
                            .each(function (t, e) {
                                !0 === l[e] && u++,
                                    l[e] !== i[e] &&
                                        ((c = !0), n._setColumnVis(t, l[e]));
                            }),
                            c &&
                                (this._redrawChildren(),
                                d(t.table().node()).trigger(
                    ...
                    _resizeAuto: function () {
                        ...
                        this.c.auto &&
                            ...
                            (e = d(o.table().header().cloneNode(!1)).appendTo(
                                t
                            )),
                            (a = d(o.table().body())
                                .clone(!1, !1)
        ...
        return (
            ...
            t.register("responsive.hasHidden()", function () {
                ...
                return (
                    !!t._responsive &&
                    -1 !== d.inArray(!1, t._responsive.s.current)
                );
            }),
            t.registerPlural(
                ...
                function () {
                    return this.iterator(
                        ...
                        function (t, e) {
                            return (
                                !!t._responsive && t._responsive.s.current[e]
                            );
                        },
                        1
                    );
