!(function (e, t) {
        ...
        if (!i && (Pe(e), (e = e || C), A)) {
            ...
            if (!(he[t + " "] || (f && f.test(t)))) {
                if (((c = t), (u = e), 1 === d && (be.test(t) || ye.test(t)))) {
                    for (
                        ((u = (Ae.test(t) && Ne(e.parentNode)) || e) == e &&
                            g.scope) ||
                            ((s = e.getAttribute("id"))
                    ...
                    return e === t
                        ...
                        : (n =
                              ...
                              (!g.sortDetached &&
                                  ...
                                  ? e === C ||
                                    (e.ownerDocument == r && D.contains(r, e))
                                      ? -1
                                      : t === C ||
                                        (t.ownerDocument == r &&
                                            D.contains(r, t))
    ...
    (D.attr = function (e, t) {
        ...
        var n = E.attrHandle[t.toLowerCase()],
            n =
                n && $.call(E.attrHandle, t.toLowerCase())
                    ? n(e, t, !A)
                    : void 0;
    ...
    ((E = T.expr =
        {
            ...
            pseudos: {
                ...
                button: function (e) {
                    return (
                        (_(e, "input") && "button" === e.type) || _(e, "button")
                    );
                },
                text: function (e) {
                    return (
    ...
    yt.getRootNode &&
        (bt = function (e) {
            return (
                ...
                e.getRootNode(_t) === e.ownerDocument
            );
        });
    function wt(e, t, n, i) {
        var r,
    ...
    function Bt(n, i, r, o) {
        ...
        if (
            ...
            if (a)
                for (
                    c = s[s.length - 1].ownerDocument, T.map(s, Rt), u = 0;
                    u < a;
                    u++
                )
                    (l = s[u]),
    ...
    T.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (t)
                if (n)
                    for (
                        o = o || m(e), s = s || m(u), i = 0, r = o.length;
                        i < r;
                        i++
                    )
                        Wt(o[i], s[i]);
            ...
            return (
                0 < (s = m(u, "script")).length && kt(s, !d && m(e, "script")),
                u
            );
        },
        ...
        T.fn.extend({
            ...
            empty: function () {
                for (var e, t = 0; null != (e = this[t]); t++)
                    1 === e.nodeType &&
                        (T.cleanData(m(e, !1)), (e.textContent = ""));
                return this;
            },
            clone: function (e, t) {
                return (
                    ...
                    if (
                        ...
                        for (r = 0; (p = d[r++]) && !e.isPropagationStopped(); )
                            (u = p),
                                ...
                                (l =
                                    (v.get(p, "events") || Object.create(null))[
                                        e.type
                            ...
                            i ||
                                ...
                                (a &&
                                    ...
                                    e.isPropagationStopped() &&
                                        u.addEventListener(f, jn),
                                    n[f](),
                                    e.isPropagationStopped() &&
                                        u.removeEventListener(f, jn),
    ...
    (function (e, t) {
            ...
            X = (i, r, e = !0) => {
                if (e) {
                    ...
                    let t = !1,
                        n = ({ target: e }) => {
                            e === r &&
                                ((t = !0), r.removeEventListener(q, n), c(i));
                        };
        ...
        let Te = "carousel",
            ...
            Ae = ".carousel-item";
        Ce, Ae;
        let ke = { ArrowLeft: we, ArrowRight: p },
            Se = {
                interval: 5e3,
                keyboard: !0,
                pause: "hover",
        ...
        function it(e, t, n) {
            ...
            t &&
                ...
                (o =
                    (0 < e.offsetHeight && et(i.height) / e.offsetHeight) ||
                    1));
        ...
        function Nt(e, t) {
            var i,
                ...
                l = Lt(
                    y(l) ? l : l.contextElement || x(e.elements.popper),
                    o,
                    s,
                    r
                ),
        ...
        let En = "modal-open",
            Cn = "modal-static";
        let An = { backdrop: !0, focus: !0, keyboard: !0 },
            kn = {
        ...
        class Sn extends t {
            ...
            show(e) {
                this._isShown ||
                    ...
                    g.trigger(this._element, Tn, { relatedTarget: e })
                        .defaultPrevented ||
                    ((this._isShown = !0),
                    (this._isTransitioning = !0),
        ...
        g.on(
            ...
            function (e) {
                ...
                e && Sn.getInstance(e).hide(),
                    Sn.getOrCreateInstance(t).toggle(this);
            }
        ),
            he(Sn),
            e(Sn);
        ...
        g.on(
            ...
            g.on(window, "load.bs.offcanvas.data-api", () => {
                for (var e of d.find(Dn)) P.getOrCreateInstance(e).show();
            }),
        ...
        let Bn = new Set(["sanitize", "allowList", "sanitizeFn"]),
            $n = "fade";
        let zn = "show",
            Vn = "hide.bs.modal",
            Xn = "hover",
        ...
        class Gn extends t {
            ...
            _createTipElement(e) {
                ...
                return (
                    e.setAttribute("id", t),
                    this._isAnimated() && e.classList.add($n),
                    e
                );
            }
            setContent(e) {
            ...
            _getConfig(e) {
                ...
                for (t of Object.keys(n)) Bn.has(t) && delete n[t];
                return (
        ...
        class si extends t {
            ...
            _initializeTargetsAndObservables() {
                ...
                for (e of d.find(ii, this._config.target))
                    e.hash &&
                        !a(e) &&
                        ((t = d.findOne(decodeURI(e.hash), this._element)),
                        s(t)) &&
        ...
        g.on(window, "load.bs.scrollspy.data-api", () => {
            for (var e of d.find('[data-bs-spy="scroll"]'))
        ...
        class hi extends t {
            ...
            _keydown(t) {
                if (
                    ["ArrowLeft", ai, "ArrowUp", li, ci, "End"].includes(t.key)
                ) {
