...
<head>
    ...
    <meta name="description" content="HRIS Pegasus - Confirm password">

    <title>Konfirmasi Sandi - HRIS Pegasus</title>
                        ...
                        <div class="col-lg-6 d-flex justify-content-center align-items-center border-0 rounded-lg auth-h100">
                            <div class="w-100 p-3 p-md-5 card border-0 bg-dark text-light" style="max-width: 32rem;">
                                <div class="mb-4 text-center">
                                    <span class="text-light">Ini adalah area aman dari aplikasi. Harap konfirmasi sandi Anda sebelum melanjutkan.</span>
                                </div>
                                ...
                                <form method="POST" action="{{ route('password.confirm') }}" class="row g-1 p-3 p-md-4">
                                    @csrf
