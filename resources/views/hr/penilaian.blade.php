    ...
    <div class="row align-items-center">
      <div class="border-0 mb-4">
        <div
          ...
          <h3 class="fw-bold mb-0">Penilai</h3>
        </div>
      </div>
    </div>
            ...
            <table
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <span class="fw-bold ms-1">Belum Dinilai</span>
                  </td>
                  <td>
      ...
      <div class="col-lg-4 col-md-5">
        <div class="card">
          <div class="card-body">
            ...
            <button id="btnNilai" class="btn btn-primary w-100 mt-3">
              Nilai
            </button>
          </div>
        </div>
...
<script>
  ...
  document
    .querySelectorAll("#myProjectTable .btn-outline-secondary")
    .forEach(function(button) {
      button.addEventListener("click", function() {
        ...
        // Isi form kanan
        document.querySelector(".card-body h6").innerText =
          selectedEmployee.nama;
        document.querySelector(".card-body small").innerText =
  ...
  document
    ...
    .addEventListener("click", function() {
      ...
      let modal = new bootstrap.Modal(
        document.getElementById("modalWizard")
      );
      modal.show();
    });
