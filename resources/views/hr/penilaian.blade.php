...
<script>
    ...
    return table.DataTable({
        ...
        columns: [
            ...
            },
            {
                ...
                render: function(data) {
                    const fotoUrl = data.photo && data.photo !== '' ? 
                        data.photo : 
                        '{{ asset("assets/images/profile_av.png") }}';
                    return `<img src="${fotoUrl}" class="rounded-circle" width="40" height="40" style="object-fit: cover;">`;
                }
            },
            {
                data: null,
        ...
        language: {
            emptyTable: "Tidak ada Kepala Divisi dengan absensi di periode yang aktif",
        ...
        function openWizardModal(divisiId, periodId) {
            ...
            console.log('Fetching KPI for Kepala Divisi from:', url);
            ...
            fetch(url)
                ...
                .then(response => {
                    console.log('KPI Response for Kepala Divisi:', response);
                    ...
                    if (kpis.length === 0) {
                        wizardContent.innerHTML = `
                            <div class="alert alert-warning">
                                ...
                                Tidak ada KPI yang ditetapkan untuk Kepala Divisi ini pada periode ini!
                            </div>
                        `;
                        return;
                    }
                ...
                .catch(err => {
                    console.error("Error load KPI for Kepala Divisi:", err);
                    wizardContent.innerHTML = `
